...
class SyspatModelEvaluation_list extends JModelList{
	...
	protected function populateState($ordering = null, $direction = null){
		...
		$filter_order = $this->getUserStateFromRequest($this->context . '.filter.ordering', 'filter_order', 'ID_EVAL_ACTION_ACTIV');
	...
	private function _buildQueryOrderBy() {
	    ...
	    $allowedOrders = explode(',','EVAL_ACT_DATE,ACTION_ACTIV_REF,DOMAIN_CODE,DIMENSION_CODE'); // array('id', 'ordering', 'published'); 
	...
	private function _buildQueryWhere() {
	    ...
	    if ($search){
			$sa = array();
			$allowedSearch = explode(',','EVAL_ACT_DATE,ACTION_ACTIV_REF,DOMAIN_CODE,DIMENSION_CODE'); // array('id', 'ordering', 'published'); 
	...
	public function getListQuery(){
	    ...
	    ->join('LEFT', $db->quoteName('eval_act_indic_pefa', 'i') . ' ON (' . $db->quoteName('e.ID_EVAL_ACTION_ACTIV') . ' = ' . $db->quoteName('i.ID_EVAL_ACTION_ACTIV') . ')')
